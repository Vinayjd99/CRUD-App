...
function UpdateUser() {
	...
	function handleSubmit(event) {
		...
		axios.put('http://localhost:8082/update/' + id, { name, email, password, dob })
			.then(res => {
				navigate('/')
			})
		...
		<div className='d-flex vh-100 justify-content-center align-items-center'>
			<div className='col-md-6 col-sm-12 bg-white rounded p-3'>
				<form onSubmit={handleSubmit}>
					...
					<button className={errorMessage ? 'btn btn-success mt-3 disabled' : 'btn btn-success mt-3'} >Update</button>
